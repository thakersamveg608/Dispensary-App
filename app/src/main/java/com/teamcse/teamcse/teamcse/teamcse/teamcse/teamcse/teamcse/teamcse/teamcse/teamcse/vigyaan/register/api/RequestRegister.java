...
public interface RequestRegister {
    ...
    Call<RegisterDataResponse> getJSON(@Field("name") String name, @Field("mobile_number") String mobile, @Field("password") String password , @Field("blood") String bloodGroup ,@Field("username") String userName);
